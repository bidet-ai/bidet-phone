/*
 * MIT License — Copyright (c) 2023 Georgi Gerganov (whisper.cpp)
 * Modifications Copyright 2026 bidet-ai contributors:
 *   Vendored verbatim from whisper.cpp examples/whisper.android/lib/src/main/jni/whisper/jni.c v1.8.4.
 *   Upstream package symbols (Java_com_whispercpp_whisper_WhisperLib_*) are unchanged
 *   so the vendored LibWhisper.kt resolves them at JVM-mangled time.
 */
#include <jni.h>
